...
awaitable<void> client_test(boost::asio::io_context& ctx, ssl::context& ssl_ctx, bool last_task=false) {
    cpool::ssl_connection connection(ctx, ssl_ctx, "google.com", 443, cpool::ssl_options{.sni=true});
